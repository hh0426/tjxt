...
public interface CourseClient {
    ...
    CourseFullInfoDTO getCourseInfoById(
            ...
            @RequestParam(value = "withCatalogue", required = false) boolean withCatalogue,//是否获取目录信息
            @RequestParam(value = "withTeachers", required = false) boolean withTeachers//是否获取教师信息
    );
}